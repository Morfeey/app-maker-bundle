...
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\Application\Contract\Query\DefaultQuery\FindIdListByFilterQueryCase;
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\ArchitectureFileCaseInterface;

class FindIdListByFilterQueryHandlerInterfaceCase extends DefaultHandlerInterfaceCase implements ArchitectureFileCaseInterface, HandlerInterfaceCaseInterface
{
    ...
    public function create(FileCase $caseParameters): ArchitectureFile
    {
        $method = $this->createInvokeMethod(
            ...
            $caseParameters,
            $this->findIdListByFilterQueryCase,
            'array'
        );
    ...
    {
        return $this->findIdListByFilterQueryCase;
    }
