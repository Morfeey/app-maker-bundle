...
class FindByFilterFieldQueryCase extends DefaultCqrsRequestCase implements ArchitectureFileCaseInterface, ArchitectureCqrsRequestInterface
{
    ...
    public function create(FileCase $caseParameters): ArchitectureFile
    {
        ...
        $fieldParameter = $this->createFieldDependency($caseParameters);

        return
            parent::create($caseParameters)
                ->setConstructor($this->createConstructorByParameters(null, $filterParameter, $fieldParameter))
