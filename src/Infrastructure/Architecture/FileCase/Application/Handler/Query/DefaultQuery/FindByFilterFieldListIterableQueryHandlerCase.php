...
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\Application\Contract\Handler\Query\DefaultQuery\FindByFilterFieldListIterableQueryHandlerInterfaceCase;
...
class FindByFilterFieldListIterableQueryHandlerCase extends DefaultHandler implements ArchitectureFileCaseInterface
{
    public function __construct(
        private readonly AttributesCreatorFacade $attributesCreatorFacade,
        private readonly FindByFilterFieldListIterableQueryHandlerInterfaceCase $handlerInterfaceCase,
