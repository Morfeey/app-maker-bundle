...
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\Application\Contract\Handler\Query\DefaultQuery\FindByFilterIterableQueryHandlerInterfaceCase;
...
class FindByFilterIterableQueryHandlerCase extends DefaultHandler implements ArchitectureFileCaseInterface
{
    public const FACTORY_METHOD_NAME = 'mappingIterable';
    public function __construct(
        private readonly AttributesCreatorFacade $attributesCreatorFacade,
        private readonly FindByFilterIterableQueryHandlerInterfaceCase $handlerInterfaceCase,
