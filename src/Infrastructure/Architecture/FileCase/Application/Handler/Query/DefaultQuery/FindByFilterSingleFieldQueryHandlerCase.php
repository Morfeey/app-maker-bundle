...
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\Application\Contract\Handler\Query\DefaultQuery\FindByFilterSingleFieldQueryHandlerInterfaceCase;
...
class FindByFilterSingleFieldQueryHandlerCase extends DefaultHandler implements ArchitectureFileCaseInterface
{

    public function __construct(
        protected readonly AttributesCreatorFacade $attributesCreatorFacade,
        protected readonly FindByFilterSingleFieldQueryHandlerInterfaceCase $handlerInterfaceCase,
