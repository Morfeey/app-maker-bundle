...
use App\Bundles\AppMakerBundle\Infrastructure\Architecture\FileCase\Application\Contract\Handler\Query\DefaultQuery\RequireOneByFilterQueryHandlerInterfaceCase;
...
class RequireOneByFilterQueryHandlerCase extends DefaultHandler implements ArchitectureFileCaseInterface
{
    ...
    public function __construct(
        ...
        private readonly RequireOneByFilterQueryHandlerInterfaceCase $handlerInterfaceCase
    ) {
    }
