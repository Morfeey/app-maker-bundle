...
class DocMethodFindByFilterSingleFieldCase extends MethodOnlyFilterInterfaceParameter implements DocCaseInterface
{
    ...
    {
        return $method->getName() === 'findByFilterSingleField';
    }
